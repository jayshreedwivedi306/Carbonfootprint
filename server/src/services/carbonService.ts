export interface CalculatorInputs {
  // Travel
  carMiles: number;
  vehicleType: 'gasoline' | 'hybrid' | 'electric' | 'none';
  publicTransitMiles: number;
  flightMiles: number;
  
  // Energy (weekly estimates)
...
export class CarbonService {
  ...
  private static readonly CAR_FACTORS = {
  ...
  private static readonly PUBLIC_TRANSIT_FACTOR = 0.10; // kg per mile
  private static readonly FLIGHT_FACTOR = 0.25;         // kg per mile

  private static readonly ELECTRICITY_FACTOR = 0.40;   // kg per kWh
  private static readonly GAS_FACTOR = 5.30;           // kg per therm

  private static readonly DIET_DAILY_FACTORS = {
